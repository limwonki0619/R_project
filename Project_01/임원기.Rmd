...
***
  ...
  데이터 분석에 들어가기 앞서 데이터 구조와 데이터의 분포를 파악해 본다.
...
#### 3.4 평점이 낮은 그룹(5점 이하)의 시간대별 평점평균과 댓글 수
...
### 4 평점이 높은 그룹(A, 9~10점)과 낮은 그룹(C, 0~5점)의 워드클라우드 
***
